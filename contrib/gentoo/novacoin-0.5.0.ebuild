...
DESCRIPTION="Number42 - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/Number42-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Number42" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/Number42-qt.protocol ${PN}.protocol
	fi
}
