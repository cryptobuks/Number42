...
const string strMessageMagic = "Number42 Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("Number42-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Number42
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Number42: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Number42", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "N42 Genesis";
        CTransaction txNew;
        txNew.nTime = 1471527190;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1471527199;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2018124; // !fTestNet ? 1575379 : 46534;
		
  
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xee0465d1cc1f1bc93142519efbb3a89d594a23320dc90f2ff48a10076d89032e"));
...
unsigned char pchMessageStart[4] = { 0xb4, 0xf0, 0xa2, 0xe5 };
