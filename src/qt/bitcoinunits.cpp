...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("N42");
    case mBTC: return QString("mN42");
    case uBTC: return QString::fromUtf8("μN42");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Number42s"));
    case mBTC: return QString(QObject::tr("Milli-Number42s (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Number42s (1 / 1,000,000)"));
    default: return QString("???");
    }
}
